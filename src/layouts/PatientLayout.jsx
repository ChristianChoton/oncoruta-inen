...
import { Activity, Bot, CalendarDays, Home, Languages, User } from 'lucide-react';
    ...
    <div className="portal-shell">
      <aside className="sidebar patient">
        ...
        <div className="sidebar-note">
          Esta vista está pensada para orientar a la paciente con lenguaje simple, recordatorios y acompañamiento.
        </div>
      </aside>
